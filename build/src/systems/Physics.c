/* Physics.c generated by valac 0.34.7, the Vala compiler
 * generated from Physics.gs, do not modify */
...
void entitas_world_free (entitasWorld* self);
void entitas_group_free (entitasGroup* self);
static void systems_physics_instance_init (systemsPhysics * self);
...
systemsPhysics* systems_physics_new (Game* game, Factory* factory) {
	...
	self = g_slice_new0 (systemsPhysics);
	systems_physics_instance_init (self);
	_tmp0_ = game;
...
void systems_physics_free (systemsPhysics* self) {
	...
	_entitas_world_release0 (self->factory);
	_entitas_group_release0 (self->physics);
	g_slice_free (systemsPhysics, self);
}

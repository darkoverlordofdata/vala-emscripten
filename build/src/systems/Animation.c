/* Animation.c generated by valac 0.34.7, the Vala compiler
 * generated from Animation.gs, do not modify */
...
void entitas_world_free (entitasWorld* self);
void entitas_group_free (entitasGroup* self);
static void systems_animation_instance_init (systemsAnimation * self);
...
systemsAnimation* systems_animation_new (Game* game, Factory* factory) {
	...
	self = g_slice_new0 (systemsAnimation);
	systems_animation_instance_init (self);
	_tmp0_ = game;
...
void systems_animation_free (systemsAnimation* self) {
	...
	_entitas_world_release0 (self->factory);
	_entitas_group_release0 (self->tweens);
	g_slice_free (systemsAnimation, self);
}

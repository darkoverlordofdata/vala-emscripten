	...
	while (TRUE) {
		...
		switch (_tmp3_) {
			...
			case SDL_KEYDOWN:
			{
				...
				guint8 _tmp9_ = 0U;
				_tmp4_ = sdx_keys;
				_tmp4__length1 = sdx_keys_length1;
				_tmp5_ = sdx__evt;
				_tmp6_ = _tmp5_.key;
				_tmp7_ = _tmp6_.keysym;
				_tmp8_ = _tmp7_.sym;
				_tmp4_[_tmp8_] = (guint8) 1;
				_tmp9_ = _tmp4_[_tmp8_];
				break;
			}
			case SDL_KEYUP:
			{
				...
				guint8 _tmp15_ = 0U;
				_tmp10_ = sdx_keys;
				_tmp10__length1 = sdx_keys_length1;
				_tmp11_ = sdx__evt;
				_tmp12_ = _tmp11_.key;
				_tmp13_ = _tmp12_.keysym;
				_tmp14_ = _tmp13_.sym;
				_tmp10_[_tmp14_] = (guint8) 0;
			...
			{
				SDL_Event _tmp16_ = {0};
				SDL_MouseMotionEvent _tmp17_ = {0};
				gint32 _tmp18_ = 0;
				SDL_Event _tmp19_ = {0};
				SDL_MouseMotionEvent _tmp20_ = {0};
				gint32 _tmp21_ = 0;
				_tmp16_ = sdx__evt;
				_tmp17_ = _tmp16_.motion;
				_tmp18_ = _tmp17_.x;
				sdx_mouseX = (gdouble) _tmp18_;
				_tmp19_ = sdx__evt;
				_tmp20_ = _tmp19_.motion;
				_tmp21_ = _tmp20_.y;
				sdx_mouseY = (gdouble) _tmp21_;
				break;
			}
